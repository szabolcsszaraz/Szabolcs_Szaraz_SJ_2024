    ...
    if(isset($_POST['user_register'])){
        ...
        if ($password === $confirm_password) {
          ...
          if ($user_object->register($email, $password)) {
              ...
              echo "<script>alert('Registrácia bola úspešná. Teraz sa môžete prihlásiť.');</script>";
          } else {
              // Registrácia zlyhala
              echo "<script>alert('Registrácia zlyhala. Skúste to prosím znova.');</script>";
          }
      } else {
          // Heslá sa nezhodujú
          echo "<script>alert('Heslá sa nezhodujú. Skúste to prosím znova.');</script>";
      }
    }
?>
<br>
