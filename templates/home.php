...
<section id="hero">
    <div class="hero-container">
      <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <!--We define an array $slides containing data for each slide. Each slide is an associative array with keys for active, image, title, and description.
        We use a foreach loop to iterate over the $slides array and generate the HTML for each slide.
